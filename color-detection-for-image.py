...
total= red+orange+yellow+green+lightblue+blue+violet+purple+pink+gray
...
print("------------Ratio of Colours------------")
per = ((red/total)*100)
per1 = ((orange/total)*100)
per2 = ((yellow/total)*100)
per3 = ((green/total)*100)
per4 = ((lightblue/total)*100)
per5 = ((blue/total)*100)
per6 = ((violet/total)*100)
per7 = ((purple/total)*100)
per8 = ((pink/total)*100)
per9 = ((gray/total)*100)

list1= [per,per1,per2,per3,per4,per5,per6,per7,per8,per9]
print("Red",per)
print("Orange",per1)
print("Yellow",per2)
print("Green",per3)
print("Light Blue",per4)
print("Blue",per5)
print("Violet",per6)
print("Purple",per7)
print("Pink",per8)
print("Gray",per9)
print("\nThe Percentage of Prominant colour is:",max(list1))
